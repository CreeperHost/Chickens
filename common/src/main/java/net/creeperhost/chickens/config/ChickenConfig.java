...
public class ChickenConfig
{
    ...
    public ChickenConfig(String name, boolean is_enabled, float lay_coefficient, ItemHolderData layitem, ItemHolderData drop_item, String spawn_type, String parent_1, String parent_2)
    {
        this.name = name;
