...
{
    private static final ResourceLocation GUI_TEXTURE = new ResourceLocation(Chickens.MOD_ID, "textures/gui/roost.png");
    private final ContainerRoost containerRoost;

    public ScreenRoost(ContainerRoost containerRoost, Inventory playerInv, Component title)
    {
